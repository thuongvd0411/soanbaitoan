...
export default function App() {
  const [config, setConfig] = useState<AppState>({
    ...
    openclawUrl: localStorage.getItem('math_app_openclaw_url') || 'https://047fbf02aaaa93a0-14-177-42-188.serveousercontent.com/v1',
  ...
  useEffect(() => {
    ...
    const oldDefaultHttps = 'https://02d1964e9dd901e2-14-177-42-188.serveousercontent.com/v1';
